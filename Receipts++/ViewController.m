...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    AddEditViewController *addEditVC = [segue destinationViewController];
    addEditVC.stack = self.stack;
    ...
    if ([[segue identifier] isEqualToString:@"editReceipt"]) {
        ...
        addEditVC.receipt = object;
        
        addEditVC.navigationItem.title = @"Edit Receipt";
    } else if ([[segue identifier] isEqualToString:@"addReceipt"]) {
        addEditVC.navigationItem.title = @"Add Receipt";
    }
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%.2f", receipt.amount];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:RECEIPT inManagedObjectContext:self.stack.managedObjectContext];
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:TIMESTAMP_KEY ascending:NO];
